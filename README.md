...
- Phase 1 graph-hard negatives are sampled directly from the candidate pool for each anchor; CPU work is still present, but the sampler avoids repeatedly shuffling full negative lists just to draw a small `hard_negative_count`.
